...
const checkInputValidity = (formElement, inputElement, {inputErrorClass, errorClass}) => {
  ...
  if (!inputElement.validity.valid) {
    ...
    showInputError(
      ...
      {inputErrorClass, errorClass}); //showInputError получает параметром форму, в которой находится проверяемое поле, и само это поле
  } else {
    // Если проходит, скроем
    hideInputError (formElement, inputElement, {inputErrorClass, errorClass}); // hideInputError получает  параметром форму, в которой находится проверяемое поле, и само это поле
  }
};
...
const setEventListeners = (formElement, {inputSelector, submitButtonSelector, ...rest}) => {
  ...
  inputList.forEach((inputElement) => {
    ...
    inputElement.addEventListener("input", () => {
      ...
      toggleButtonState(inputList, buttonElement, rest); // вызов проверит состояние кнопки при каждом изменении символа в любом из полей.
...
enableValidation ({ //вызываем функцию валидации
 //поля форм, которые надо проверить
